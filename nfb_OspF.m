...
% y(7): OspF
% #####################
dy(1) = tau*(kp*(ERKtot-y(1))*(aE+TCR) - kd1*y(3)*y(1)/(y(1)+KE) - kd2*y(7)*y(1)/(y(1)+KO1));
dy(2) = tau*(knin*(Ntot-y(2))*(alpha*KI/(KI+y(4))+TCR) - kiin*y(4)*y(2)/(KN+y(2)));
...
dy(7) = tau*(aO*y(1)/(y(1)+Knode1) - gamma3*y(7));
end